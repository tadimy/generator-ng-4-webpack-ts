import {Component, OnInit, ViewEncapsulation, HostBinding, ViewChild, ElementRef, Input} from '@angular/core';
import { SidenavItem } from "./sidenav-item.model";
import { SidenavService } from "../sidenav/sidenav.service";

@Component({
  selector: 'yt-sidenav-item',
  templateUrl: './sidenav-item.component.pug',
